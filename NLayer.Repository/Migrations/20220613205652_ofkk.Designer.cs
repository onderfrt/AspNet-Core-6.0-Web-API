            ...
            modelBuilder.Entity("NLayer.Core.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            CreatedDate = new DateTime(2022, 6, 13, 23, 56, 52, 303, DateTimeKind.Local).AddTicks(9896),
                            Name = "Kalem1",
                            Price = 100m,
                            Stock = 20
                        },
                        new
                        {
                            Id = 2,
                            CategoryId = 1,
                            CreatedDate = new DateTime(2022, 6, 13, 23, 56, 52, 303, DateTimeKind.Local).AddTicks(9907),
                            Name = "Kalem2",
                            Price = 150m,
                            Stock = 40
                        },
                        new
                        {
                            Id = 3,
                            CategoryId = 2,
                            CreatedDate = new DateTime(2022, 6, 13, 23, 56, 52, 303, DateTimeKind.Local).AddTicks(9909),
                            Name = "Kalem3",
                            Price = 200m,
                            Stock = 60
                        });
